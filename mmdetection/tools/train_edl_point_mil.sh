...
# Usage:
#   bash tools/train_edl_point_mil.sh [GPUS] [WORK_DIR] [-- extra args]
# Examples:
#   bash tools/train_edl_point_mil.sh
#   bash tools/train_edl_point_mil.sh 2
#   bash tools/train_edl_point_mil.sh 1 work_dirs/edl_point_mil_r50_fpn_1x -- --resume auto
#   bash tools/train_edl_point_mil.sh 1 work_dirs/edl_point_mil_r50_fpn_1x -- --cfg-options train_dataloader.batch_size=2
...
GPUS="${1:-1}"
WORK_DIR="${2:-work_dirs/edl_point_mil_r50_fpn_1x}"
