...
model = dict(
    ...
    roi_head=dict(
        ...
        proposal_generator=dict(
            ...
            box_offset=8,
            num_pos_samples=16,
            mil_bag_size_base=64,
            keep_positive_bag_prob=0.5,
            pseudo_box_coord_space='original',
            ...
            jitter_rescale_with_class_priors=True,
            jitter_base_scales=[32, 64, 128, 256],
            jitter_aspect_ratios=[0.5, 1.0, 2.0],
